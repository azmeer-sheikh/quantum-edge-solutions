...
export function HomePage({ onNavigate }: HomePageProps) {
  ...
  const metrics = [
    { value: '150+', label: 'Clients Served', icon: <Database className="w-6 h-6" /> },
    { value: '90%', label: 'Client Retention', icon: <TrendingUp className="w-6 h-6" /> },
